    ...
    _.prototype = {
        ...
        upload: function() {
            var i, t, a, n = this,
                ...
                l = {}, o = !e.isEmptyObject(n.getExtraData());
        ...
        initPreviewDeletes: function() {
            var i = this,
                a = i.deleteExtraData || {}, n = function() {
        ...
        change: function(i) {
            ...
            }] : [] : i.target.files; if (R(r) || 0 === r.length) return m || a.clear(), a.showFolderError(v), void a.raise("fileselectnone");
        ...
        renderRemove: function() {
            var e = this,
                ...
                t = "";
            //praveen - made style display none at below line
            return e.showRemove ? (e.isDisabled && (t = " disabled "), '<button style="display:none;" type="button" title="' + e.removeTitle + '" class="' + i + '"' + t + ">" + e.removeIcon + e.removeLabel + "</button>") : ""
        },
        ...
        renderUpload: function() {
            var e = this,
                ...
                a = "";
            //praveen - made style display none at below line
            return e.showUpload ? (e.isDisabled && (a = " disabled "), t = !e.isUploadable || e.isDisabled ? '<button type="submit"  title="' + e.uploadTitle + '"class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</button>" : '<a href="' + e.uploadUrl + '" title="' + e.uploadTitle + '" style="display:none;" class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        }
        ...
        dropZoneTitle: "Drag & drop an image here"
